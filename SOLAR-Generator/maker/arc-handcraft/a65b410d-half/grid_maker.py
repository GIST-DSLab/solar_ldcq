                    ...
                    for x_up in range(p_x-1, -1, -1):
                        if y_up < w-1:
                            ...
                            if (j == num_examples):
                                ...
                                operations.append(colors_list[0])
                    y_down = p_y
                    for x_down in range(p_x+1, h):
                        if y_down > 0:
                            ...
                            if (j == num_examples):
                                ...
                                operations.append(colors_list[2])
                if choice == 1:
                    y_down = p_y
                    for x_down in range(p_x+1, h):
                        if y_down > 0:
